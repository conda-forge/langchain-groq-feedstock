About langchain-groq-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/langchain-groq-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/langchain-groq-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add langchain-groq
# for installing globally
pixi global install langchain-groq
```
...
It is possible to list all of the versions of `langchain-groq` available on your platform:
...
```
pixi search langchain-groq --channel conda-forge
```
